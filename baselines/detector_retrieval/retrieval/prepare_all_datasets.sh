...
python prepare_dataset_retrieval.py --dataset-train instre-s2-train --dataset-train-scale 600 --dataset-val instre-s2-val --dataset-val-scale 600 --datasets-test instre-s2-val instre-s2-test --datasets-test-scale 600
