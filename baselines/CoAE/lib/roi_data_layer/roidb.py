...
This file is a change version of
https://github.com/timy90022/One-Shot-Object-Detection/blob/master/lib/roi_data_layer/roidb.py
"""
import numpy as np
import PIL
...
def prepare_roidb(imdb):
  ...
  for i in range(len(imdb.image_index)):
    ...
    if 'width' not in roidb[i] or 'height' not in roidb[i]:
      cur_size = PIL.Image.open(imdb.image_path_at(i)).size
      roidb[i]['width'] = cur_size[0]
      roidb[i]['height'] = cur_size[1]
